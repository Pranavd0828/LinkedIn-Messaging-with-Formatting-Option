...
**What we are doing**
We are introducing a comprehensive Rich Text Formatting toolbar that lives directly above the message composition area in the main chat window. This feature allows users to apply Bold, Italic, and Strikethrough styles to their messages before sending them. It is a visual enhancement to the existing messaging product that leverages standard web technologies to give users more control over how their words are presented.
